...
export class About {
  create(): HTMLElement {
    ...
    web_development_para.textContent = `
      ចូលរួមក្នុងកម្មវិធីមួយឆ្នាំពេញដែលបង្រៀនដោយអ្នកជំនាញដែលបានទទួលការបណ្តុះបណ្តានៅអឺរ៉ុប។
    ...
    mathematics_para.textContent = `
      ...
      បង្រៀនដោយគ្រូបង្រៀនដែលមានបទពិសោធន៍ និងបានទទួលការបណ្តុះបណ្តានៅអឺរ៉ុប។
    ...
    conclusion_para.textContent = `
      យើងខ្ញុំរីករាយនឹងផ្តល់នូវបរិយាកាសការរៀនសូត្រដែលមានសីលធម៌ និង ទំនួលខុសត្រូវខ្ពស់។ គ្រូបង្រៀនដែលមានបទពិសោធន៍របស់យើងខ្ញុំ ប្តេជ្ញាជួយអ្នកឱ្យទទួលបានជោគជ័យ។ យើងខ្ញុំផ្តល់អទ្ទិភាពដល់ការរៀនសូត្រជាក់ស្ដែង និង ការងារជាលក្ខណៈ professional ដើម្បីធានាថាអ្នកទទួលបានជំនាញ និងចំណេះដឹងជាក់ស្ដែងដែលអ្នកត្រូវកា៕
    `;
